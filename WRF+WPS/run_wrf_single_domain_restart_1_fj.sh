...
export SUBDIR=WRF_multiple_${EXPNAME}_restart
export FORT90L=-Wl,-T
#
llio_transfer ${CRRNTDIR}/matthew_1deg.tar.gz
llio_transfer ${CRRNTDIR}/matthew_sst.tar.gz
llio_transfer ${CRRNTDIR}/namelist_${EXPNAME}_restart_1.input
...
rsync -a ${WRKDIR}/${SUBDIR} ./
#
cd ${SUBDIR}/test/em_real
#
ln -s ../../../WPS_serial_${EXPNAME}/met_em.d0*.2016-10* ./
#
cp ${CRRNTDIR}/namelist_${EXPNAME}_restart_1.input ./namelist.input
...
llio_transfer --purge ${CRRNTDIR}/namelist_${EXPNAME}_restart_1.input
