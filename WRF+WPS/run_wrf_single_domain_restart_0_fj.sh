...
llio_transfer ${CRRNTDIR}/namelist_${EXPNAME}_restart_0.input
...
#
cp ${CRRNTDIR}/namelist_${EXPNAME}_restart_0.input ./namelist.input
...
llio_transfer --purge ${CRRNTDIR}/namelist_${EXPNAME}_restart_0.input
